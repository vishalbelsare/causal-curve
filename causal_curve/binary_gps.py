...
"""
Defines the binary Generalized Prospensity Score (GPS) model class
"""
...
class BinaryGPS(Core):
    ...
    the outcome variable. Assumes continuous treatment and binary outcome.
